...
![Authorize external resources on the Profile tab](img/ex-analysis-external-resources.png)
...
![Launch a workspace by clicking on the Workspace tab and clicking the Launch button](img/ex-analysis-launch-wkspc.png)
...
![Collapse the Account Information section to make more screen space. Generate a button to pull example notebooks into your workspace by running all cells.](img/ex-analysis-run-cells.png)
...
![Scroll up to find the green button, and click it to pull the example notebooks into your workspace](img/ex-analysis-pull-notebooks.png)  
