...
2. Where can I see individual study metadata?  
...
3. Do I need to store my data in a particular location to participate in the HEAL platform?  
...
5. I do not have access to a specific study, how can I get access?  
    ...
    Repositories maintain governance over the data that they archive. To request access to a controlled-access dataset, you must visit the host repository (linked in the Data tab of the study record) and follow their process for requesting access. Once the repository authorizes you to access the dataset, you will also be able to access it through the HEAL Data Platform."  
...
12. My data file download using the Gen3-client gets stuck, where can I get help?  
      
    For troubleshooting, please see the [Gen3-client documentation here](https://docs.gen3.org/gen3-resources/tools/data-client/). If errors persist, contact our [help desk](mailto:heal-support@gen3.org).  
      
    
13. The Gen3-client shows errors, where can I get help?  
    ...
    For more troubleshooting, please see the [Gen3-client documentation here](https://docs.gen3.org/gen3-resources/tools/data-client/). If errors persist, contact our [help desk](mailto:heal-support@gen3.org).  
      
    
14. I want to work interactively on the Tutorial Notebooks. Show me how.  
      
    [Click here](platform_example_analyses.md#using-notebooks-in-a-heal-workspace) to learn how to get the notebooks into your HEAL workspace.  
      
    
15. What are the current Tutorial Notebooks?  
      
    You can [see all the available notebooks here](https://uc-cdis.github.io/heal-notebooks-pages/), and you can [download the notebooks here](https://github.com/uc-cdis/heal-notebooks/tree/main/notebooks).    
      
    
16. How do I link my account to a FAIR enabled repository?  
...
17. What do the Workspaces have to offer?  
